...
$(function () {
    ...
    if ($("#ad_text_under_commentbox").length) {
        var now = new Date();
        var adstr = '';
        if (now <= new Date('December 31,2012')) {
            adstr += '<a href="http://job.cnblogs.com/Offer/28184/" target="_blank"><b>沪江网诚聘中级/高级.NET程序员（社区方向）</b></a><br/>';
            adstr += '<a href="http://www.cnblogs.com/cmt/archive/2012/12/17/2821527.html" target="_blank"><b>园豆兑换阿里云代金券，1元体验阿里云Linux主机</b></a><br/>';
        }        
